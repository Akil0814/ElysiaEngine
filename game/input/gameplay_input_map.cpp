...
elysia::input::InputActionMap make_default_gameplay_input_map()
{
    ...
    require_registered(map.register_action(
        ...
        {{actions::Move, Button2DInputBinding{RawInputControl::KeyA, RawInputControl::KeyD,
         ...
         {actions::Move,
          Axis2DInputBinding{RawInputAxis::GamepadLeftX, RawInputAxis::GamepadLeftY, 1.0f, 1.0f}}}));

    require_registered(map.register_action({actions::Jump, InputActionValueType::Button},
                                           {button(actions::Jump, RawInputControl::KeySpace),
                                            button(actions::Jump, RawInputControl::GamepadSouth)}));
    require_registered(map.register_action({actions::Primary, InputActionValueType::Button},
    ...
    require_registered(map.register_action({actions::Secondary, InputActionValueType::Button},
                                           {button(actions::Secondary, RawInputControl::KeyK),
                                            button(actions::Secondary, RawInputControl::GamepadNorth)}));
    require_registered(map.register_action({actions::Guard, InputActionValueType::Button},
    ...
    require_registered(map.register_action({actions::Dash, InputActionValueType::Button},
    ...
    require_registered(map.register_action({actions::Pause, InputActionValueType::Button},
