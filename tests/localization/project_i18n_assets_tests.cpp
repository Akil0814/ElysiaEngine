...
const std::set<std::string> expected_keys = {
    ...
    "physics_tests.awake",
    "physics_tests.back",
    "physics_tests.cases.ccd.expected",
    "physics_tests.cases.ccd.purpose",
    "physics_tests.cases.ccd.title",
    "physics_tests.cases.combat_collider.expected",
    "physics_tests.cases.combat_collider.purpose",
    "physics_tests.cases.combat_collider.title",
    "physics_tests.cases.combat_platform.expected",
    "physics_tests.cases.combat_platform.purpose",
    "physics_tests.cases.combat_platform.title",
    "physics_tests.cases.combat_topdown.expected",
    "physics_tests.cases.combat_topdown.purpose",
    "physics_tests.cases.combat_topdown.title",
    "physics_tests.cases.filters.expected",
    "physics_tests.cases.filters.purpose",
    "physics_tests.cases.filters.title",
    "physics_tests.cases.joints.expected",
    "physics_tests.cases.joints.purpose",
    "physics_tests.cases.joints.title",
    "physics_tests.cases.lifecycle.expected",
    "physics_tests.cases.lifecycle.purpose",
    "physics_tests.cases.lifecycle.title",
    "physics_tests.cases.materials.expected",
    "physics_tests.cases.materials.purpose",
    "physics_tests.cases.materials.title",
    "physics_tests.cases.motion.expected",
    "physics_tests.cases.motion.purpose",
    "physics_tests.cases.motion.title",
    "physics_tests.cases.one_way.expected",
    "physics_tests.cases.one_way.purpose",
    "physics_tests.cases.one_way.title",
    "physics_tests.cases.queries.expected",
    "physics_tests.cases.queries.purpose",
    "physics_tests.cases.queries.title",
    "physics_tests.cases.stress_bodies.expected",
    "physics_tests.cases.stress_bodies.purpose",
    "physics_tests.cases.stress_bodies.title",
    "physics_tests.cases.stress_contacts.expected",
    "physics_tests.cases.stress_contacts.purpose",
    "physics_tests.cases.stress_contacts.title",
    "physics_tests.cases.stress_tiles.expected",
    "physics_tests.cases.stress_tiles.purpose",
    "physics_tests.cases.stress_tiles.title",
    "physics_tests.cases.tiles.expected",
    "physics_tests.cases.tiles.purpose",
    "physics_tests.cases.tiles.title",
    "physics_tests.cases.timing.expected",
    "physics_tests.cases.timing.purpose",
    "physics_tests.cases.timing.title",
    "physics_tests.combat",
    "physics_tests.contacts",
    "physics_tests.debug",
    "physics_tests.dropped",
    "physics_tests.expected_value",
    "physics_tests.failed",
    "physics_tests.failure",
    "physics_tests.free_play",
    "physics_tests.high",
    "physics_tests.low",
    "physics_tests.medium",
    "physics_tests.mixed",
    "physics_tests.objects",
    "physics_tests.off",
    "physics_tests.on",
    "physics_tests.passed",
    "physics_tests.pause",
    "physics_tests.paused",
    "physics_tests.physics",
    "physics_tests.ready",
    "physics_tests.reset",
    "physics_tests.run",
    "physics_tests.running",
    "physics_tests.samples",
    "physics_tests.single_step",
    "physics_tests.steps",
    "physics_tests.stress",
    "physics_tests.timing",
    "physics_tests.title",
